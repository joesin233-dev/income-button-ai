import { buildMarketingCopyPrompt } from "./_lib/prompts.js";
...
export default async function handler(req, res) {
  ...
  try {
    const prompt = buildMarketingCopyPrompt(opportunity, answers);
    ...
    res.status(500).json({ error: "Something went wrong generating your marketing copy. Try again." });
  }
}
