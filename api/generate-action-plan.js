import { buildActionPrompt } from "./_lib/prompts.js";
...
export default async function handler(req, res) {
  ...
  try {
    const prompt = buildActionPrompt(opportunity, answers);
    ...
    res.status(500).json({ error: "Something went wrong generating your action plan. Try again." });
  }
}
